...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Es(e,t,n){return new ya({name:`SphericalGaussianBlur`,defines:{SAMPLES:ds,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},sigma:{value:0},mipInt:{value:0}},vertexShader:ks(),fragmentShader:`
	...
	if ( coord.x >= 1.0 ) {
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}};Ad.BlurDirectionX=new U(1,0),Ad.BlurDirectionY=new U(0,1);var jd={name:`OutputShader`,uniforms:{tDiffuse:{value:null},toneMappingExposure:{value:1}},vertexShader:`
		precision highp float;
...
`;continue}if((u=l.match(i))&&(c.gamma=parseFloat(u[1])),(u=l.match(a))&&(c.exposure=parseFloat(u[1])),(u=l.match(o))&&(c.valid|=2,c.format=u[1]),(u=l.match(s))&&(c.valid|=4,c.height=parseInt(u[1],10),c.width=parseInt(u[2],10)),c.valid&2&&c.valid&4)break}return c.valid&2||t(3,`missing format specifier`),c.valid&4||t(3,`missing image size specifier`),c},i=function(e,n,r){let i=n;if(i<8||i>32767||e[0]!==2||e[1]!==2||e[2]&128)return new Uint8Array(e);i!==(e[2]<<8|e[3])&&t(3,`wrong scanline width`);let a=new Uint8Array(4*n*r);a.length||t(4,`unable to allocate buffer space`);let o=0,s=0,c=4*i,l=new Uint8Array(4),u=new Uint8Array(c),d=r;for(;d>0&&s<e.byteLength;){s+4>e.byteLength&&t(1),l[0]=e[s++],l[1]=e[s++],l[2]=e[s++],l[3]=e[s++],(l[0]!=2||l[1]!=2||(l[2]<<8|l[3])!=i)&&t(3,`bad rgbe scanline format`);let n=0,r;for(;n<c&&s<e.byteLength;){r=e[s++];let i=r>128;if(i&&(r-=128),(r===0||n+r>c)&&t(3,`bad scanline data`),i){let t=e[s++];for(let e=0;e<r;e++)u[n++]=t}else u.set(e.subarray(s,s+r),n),n+=r,s+=r}let f=i;for(let e=0;e<f;e++){let t=0;a[o]=u[e+t],t+=i,a[o+1]=u[e+t],t+=i,a[o+2]=u[e+t],t+=i,a[o+3]=u[e+t],o+=4}d--}return a},a=function(e,t,n,r){let i=2**(e[t+3]-128)/255;n[r+0]=e[t+0]*i,n[r+1]=e[t+1]*i,n[r+2]=e[t+2]*i,n[r+3]=1},s=function(e,t,n,r){let i=2**(e[t+3]-128)/255;n[r+0]=yn.toHalfFloat(Math.min(e[t+0]*i,65504)),n[r+1]=yn.toHalfFloat(Math.min(e[t+1]*i,65504)),n[r+2]=yn.toHalfFloat(Math.min(e[t+2]*i,65504)),n[r+3]=yn.toHalfFloat(1)},c=new Uint8Array(e);c.pos=0;let l=r(c),u=l.width,d=l.height,m=i(c.subarray(c.pos),u,d),h,g,_;switch(this.type){case f:_=m.length/4;let e=new Float32Array(_*4);for(let t=0;t<_;t++)a(m,t*4,e,t*4);h=e,g=f;break;case p:_=m.length/4;let t=new Uint16Array(_*4);for(let e=0;e<_;e++)s(m,e*4,t,e*4);h=t,g=p;break;default:throw Error(`THREE.HDRLoader: Unsupported type: `+this.type)}return{width:u,height:d,data:h,header:l.string,gamma:l.gamma,exposure:l.exposure,type:g,colorSpace:M,minFilter:o,magFilter:o,generateMipmaps:!1,flipY:!0}}setDataType(e){return this.type=e,this}};export{Sa as A,ca as B,co as C,Y as D,Fe as E,aa as F,ua as G,cr as H,W as I,$e as J,U as K,j as L,xo as M,sa as N,Dr as O,Ci as P,Rt as R,p as S,$r as T,Jn as U,Co as V,la as W,X as _,Dd as a,Lt as b,hu as c,Ai as d,Cn as f,Mi as g,ji as h,Od as i,xa as j,hr as k,xs as l,Ei as m,Md as n,bu as o,Rn as p,G as q,Ad as r,vu as s,Nd as t,mu as u,Ni as v,Gr as w,kt as x,Oo as y,ya as z};